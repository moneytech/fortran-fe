...
typedef enum { INTRINSIC_UPLUS=0, INTRINSIC_UMINUS, INTRINSIC_PLUS, 
   INTRINSIC_MINUS, INTRINSIC_TIMES, INTRINSIC_DIVIDE, INTRINSIC_POWER,
...
typedef enum { 
  ...
  ST_POINTER_ASSIGNMENT, ST_SELECT_CASE, ST_SEQUENCE, ST_STATEMENT_FUNCTION,
  ST_DERIVED_DECL, ST_NONE
} g95_statement;
...
g95_component *g95_find_component(g95_symbol *, char *);
...
match g95_intrinsic_func_interface(g95_expr *, int *, int);
